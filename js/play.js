window.onload = function() {
    ...
    document.querySelector('#playTutorial').style.visibility = "visible";
...
function playTutorialDel() {
    ...
    document.querySelector('#playTutorial').classList.replace('animate__fadeIn', 'animate__fadeOut');
    setTimeout(function () {
        document.querySelector('#playTutorial').style.visibility = "hidden";
...
audio.src = audioURL;
link.href = audioURL;
link.download = "SOOMTICKER_Voice.mp3";
